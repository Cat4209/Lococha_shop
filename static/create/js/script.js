$(document).ready(()=>{
    $(".input-group-select").css("opacity", "0");
    $(".input-group-select").css("visibility", "hidden");
    $("select[name='GenderCat']").bind("change", ()=>{
        let gender = $("select[name='GenderCat']").val();
        if(gender != 0){
            $(".input-group-select").css("opacity", "1");
            $(".input-group-select").css("visibility", "visible");
        }else{
            $(".input-group-select").css("opacity", "0");
            $(".input-group-select").css("visibility", "hidden");
        }
